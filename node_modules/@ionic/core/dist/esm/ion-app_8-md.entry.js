import { r as registerInstance, d as getIonMode, e as getElement, h, H as Host, c as createEvent, f as readTask } from './chunk-83ae3fca.js';
...
import { t as transition } from './chunk-0b9585cb.js';
...
function importStatusTap() {
    ...
    if (statusTap) {
        import('./status-tap-d8c7b8b1.js').then(module => module.startStatusTap());
    }
}
...
class RouterOutlet {
    ...
    async componentDidLoad() {
        this.gesture = (await import('./swipe-back-c7dc9eab.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart(), () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
