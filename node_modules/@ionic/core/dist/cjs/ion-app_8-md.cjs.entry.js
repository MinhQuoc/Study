...
const __chunk_10 = require('./chunk-80bbc4a6.js');
...
function importStatusTap() {
    ...
    if (statusTap) {
        new Promise(function (resolve) { resolve(require('./status-tap-92c2ff70.js')); }).then(module => module.startStatusTap());
    }
}
...
class RouterOutlet {
    ...
    async componentDidLoad() {
        this.gesture = (await new Promise(function (resolve) { resolve(require('./swipe-back-d59d7e97.js')); })).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart(), () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
